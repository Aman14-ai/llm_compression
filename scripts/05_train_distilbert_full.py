...
OUTPUT_DIR = Path("models_updated/distilbert_agnews_bs8_ep3_wd001_warmup500")
...
def main():
    ...
    print("=" * 100)
    print("FULL DistilBERT baseline training on AG News")
    print("=" * 100)
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        print(f"\nEpoch {epoch + 1} average training loss: {avg_epoch_loss:.6f}")
    ...
    result_path = RESULTS_DIR / "distilbert_full_baseline_metrics_bs8_ep3_wd001_warmup500.json"

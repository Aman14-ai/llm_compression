...
OUTPUT_JSON = RESULTS_DIR / "distilbert_baseline_inference_benchmark_bs8_ep3_wd001_warmup500.json"
...
def benchmark(model, dataloader, device):
    ...
    result = {
        ...
        "experiment_tag": "bs8_ep3_wd001_warmup500",
...
def main():
    ...
    print("=" * 100)
    print("DistilBERT AG News inference benchmark")
    print("=" * 100)
    print("Device:", DEVICE)
